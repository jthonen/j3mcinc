...
export default function LoadingBars () {
    return (
        <svg width="200px" height="200px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" className="lds-bars" style={{ background: "none" }}>
            <rect ng-attr-x="{{config.x1}}" y="30" ng-attr-width="{{config.width}}" height="40" fill="#c6ed2c" x="15" width="10">
            ...
            <rect ng-attr-x="{{config.x2}}" y="30" ng-attr-width="{{config.width}}" height="40" fill="#c6ed2c" x="35" width="10">
            ...
            <rect ng-attr-x="{{config.x3}}" y="30" ng-attr-width="{{config.width}}" height="40" fill="#c6ed2c" x="55" width="10">
            ...
            <rect ng-attr-x="{{config.x4}}" y="30" ng-attr-width="{{config.width}}" height="40" fill="#c6ed2c" x="75" width="10">
